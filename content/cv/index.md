...
My skills include creating user interface guidelines and component libraries, along with wireframes, prototypes, and high-fidelity mockups. I also like collaborating on user interviews, usability testing, and surveys to better understand user needs and improve the overall experience.

Beyond design, I enjoy contributing to front-end development using native web technologies like HTML, CSS, and JavaScript, as well as frameworks such as React and Hugo.
